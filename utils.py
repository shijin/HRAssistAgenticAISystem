...
def seed_services(employee_manager, leave_manager, meeting_manager, ticket_manager):
    ...
    employees_data = [
        # Leadership
        {"emp_id": "E001", "name": "Shijin Ramesh", "manager_id": "E001", "email": "shijin@theidals.com"},

        # Management team under Shijin
        {"emp_id": "E002", "name": "Anil Vishwakarma", "manager_id": "E001", "email": "anil@theidals.com"},
        {"emp_id": "E003", "name": "Aditya Chavan", "manager_id": "E001", "email": "aditya@theidals.com"},
        {"emp_id": "E004", "name": "Netra Hachiko", "manager_id": "E001", "email": "netra@theidals.com"},

        # Education team under Shijin
        {"emp_id": "E005", "name": "Vidya Chaudhary", "manager_id": "E001", "email": "vidya@theidals.com"},
        {"emp_id": "E006", "name": "Harsha Shah", "manager_id": "E001", "email": "harsha@theidals.com"},
        {"emp_id": "E007", "name": "Karthik Priyadarshan", "manager_id": "E001", "email": "karthik@theidals.com"},
    ]
    ...
    # Create ticket data
    ticket_items = ["Dance course content", "Video recording equipment", "Audio / music licensing", "Learning Management System (LMS)",
                    "Website or app feature", "Payment gateway", "Student enrollment issue", "Instructor onboarding", "Live class setup",
                    "Certificate generation", "Marketing creatives", "Analytics and reporting", "Server or hosting",
                    "Customer support tools", "Community platform access"]
    ticket_reasons = ["New course launch", "Content update or correction", "Instructor request", "Student reported issue",
                      "Technical bug or downtime", "Performance or quality improvement", "Platform scalability requirement",
                      "Compliance or certification requirement", "Marketing or growth campaign", "Payment or refund issue",
                      "Operational dependency", "User experience enhancement", "Data accuracy or reporting issue",
                      "Security or access control", "Business continuity requirement"]
...
if __name__ == "__main__":
    ...
    print(employee_manager.get_employee_details("E002"))
